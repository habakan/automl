...
Example usage:
    PYTHONPATH=".:$PYTHONPATH" python dataset/pascalformat_tfrecord.py --data_dir {path_to_data_dir} --output_path {output_tfrecord_path} --label_map_json_path {label_map_json_path} --image_dir {image_dir_name}
"""
import hashlib
import io
import json
...
flags.DEFINE_string("image_dir", None, "image dictionary.")
